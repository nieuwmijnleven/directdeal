...
/**
 * Mapper for converting between ChattingRoom entity and ChattingRoomDTO.
 * Delegates mapping of ChattingMessage and ChattingMessageDTO to the injected ChattingMessageMapper.
 */
...
public class ChattingRoomMapper implements Mapper<ChattingRoom, ChattingRoomDTO> {
    ...
    /**
     * Converts ChattingRoomDTO to ChattingRoom entity.
     *
     * @param dto the ChattingRoomDTO
     * @return the ChattingRoom entity
     */
    @Override
    ...
    /**
     * Converts ChattingRoom entity to ChattingRoomDTO.
     *
     * @param entity the ChattingRoom entity
     * @return the ChattingRoomDTO
     */
    @Override
